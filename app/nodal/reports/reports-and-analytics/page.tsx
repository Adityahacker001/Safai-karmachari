...
const Reports = () => {
  ...
  const quickStats = [
    { title: 'Reports Generated This Month', value: '24', icon: FileText, color: 'blue' },
    { title: 'Downloads This Week', value: '156', icon: Download, color: 'green' },
    { title: 'Scheduled Reports', value: '8', icon: Calendar, color: 'yellow' },
    { title: 'Data Sources', value: '12', icon: BarChart3, color: 'purple' },
  ];
