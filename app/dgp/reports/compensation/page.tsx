  ...
  const filteredCases = useMemo(() => {
    return mockCompensationCases
      ...
      .filter(c => 
        ...
        c.incidentId.toLowerCase().includes(searchTerm.toLowerCase()) || 
    ...
    >
      ...
      <header className="max-w-7xl mx-auto mb-8">
        ...
        <nav className="flex items-center text-sm font-medium text-slate-500" aria-label="Breadcrumb">
          ...
          <ChevronRight size={16} className="mx-1.5" />
          <span className="text-slate-800 font-semibold">Compensation Report</span>
        </nav>
        {/* Title */}
        <div className="flex items-center justify-between mt-3">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-navy-900">Compensation Report</h1>
              <p className="text-sm text-slate-600">State-wide tracking of compensation status for SK incidents.</p>
            </div>
          </div>
      ...
      <GlassCard className="max-w-7xl mx-auto mb-8" noHover>
        <div className="flex items-center gap-3 px-6 py-4 border-b border-sky-100">
          ...
          <h3 className="text-base font-semibold text-navy-800">Filter Compensation Cases</h3>
        </div>
        <div className="p-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
            ...
            <div className="relative col-span-2 lg:col-span-1">
              <input 
                type="text" 
                placeholder="Search Worker, ID, FIR..." 
                value={searchTerm}
