...
export default function GrievanceFeedbackEntry() {
  ...
  return (
    ...
    >
      ...
      <header className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 border-b-2 border-blue-200 shadow-xl px-3 sm:px-4 md:px-6 lg:px-10 overflow-hidden rounded-2xl">
