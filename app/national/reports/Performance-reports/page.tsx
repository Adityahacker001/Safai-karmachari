...
function StarRating({ value, max = 5 }: { value: number; max?: number }) {
    // Replace star icons with a numeric display (preserve layout and spacing)
        ...
        <div>
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                 <div className="flex space-x-1 border-b-2 border-slate-200 dark:border-gray-700">
                     <Button variant="ghost" onClick={() => setActiveTab('good')} className={cn("font-semibold pb-3 rounded-none border-b-4", activeTab === 'good' ? 'text-green-600 border-green-600' : 'text-gray-500 border-transparent')}><span className="mr-2 h-5 w-5 inline-block" aria-hidden /> Good Performers</Button>
