...
const roleConfig = {
  ...
  "sp-cp": {
    ...
    dataEntry: [ { name: "Investigation Progress", icon: FilePenLine, href: "/sp-cp/data-entry/investigation" }, { name: "Grievance Feedback", icon: MessageSquareWarning, href: "/sp-cp/data-entry/grievance" }, { name: "General Feedback", icon: ClipboardList, href: "/sp-cp/data-entry/feedback" }, { name: "Direction Compliance", icon: Gavel, href: "/sp-cp/data-entry/compliance" }, ],
    reports: [ { name: "Contractors Report", icon: Building, href: "/sp-cp/reports/contractors" }, { name: "Workers Report", icon: Users, href: "/sp-cp/reports/workers" }, { name: "Grievances Report", icon: FileWarning, href: "/sp-cp/reports/grievances" }, { name: "Direction Report", icon: FileText, href: "/sp-cp/reports/directions" }, { name: "Total Cases Report", icon: FolderKanban, href: "/sp-cp/reports/total-cases" }, { name: "Pending Cases Report", icon: FolderClock, href: "/sp-cp/reports/pending-cases" }, { name: "Compensation Report", icon: DollarSign, href: "/sp-cp/reports/compensation" }, { name: "Annual Report", icon: Book, href: "/sp-cp/reports/annual-report" }, ],
  ...
  "dgp": {
    ...
    reports: [ { name: "Total Contractors Report", icon: Building, href: "/dgp/reports/contractors" }, { name: "Total Workers Report", icon: Users, href: "/dgp/reports/workers" }, { name: "Grievances Report", icon: FileWarning, href: "/dgp/reports/grievances" }, { name: "Direction Report", icon: FileText, href: "/dgp/reports/directions" }, { name: "Total Cases Report", icon: FolderKanban, href: "/dgp/reports/total-cases" }, { name: "Pending Cases Report", icon: FolderClock, href: "/dgp/reports/pending-cases" }, { name: "Compensation Report", icon: DollarSign, href: "/dgp/reports/compensation" }, { name: "District SP/CP Onboarding", icon: Target, href: "/dgp/reports/onboarding" }, { name: "Annual Report", icon: Book, href: "/dgp/reports/annual-report" }, ],
